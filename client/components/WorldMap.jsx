...
function WorldMap(props) {
  ...
  >
    ...
    <path
      ...
      data-name="Albania"
      data-id="AL"
      d="m1077.5 300.5-2 3.1.5 1.9 1 1-.5 1.9-.1 4.3.7 3 3 2.1.2 1.4 1 .4 2.1-3 .1-2.1 1.6-.9V312l-2.3-1.6-.9-2.6.4-2.1-.5-2.3-1.3-.6-1.3-1.6-1.3.5-.4-1.2z"
    />
    <path
      onClick={handleClick}
      id="AE"
      ...
      data-id="AE"
      d="m1283.9 408.6-1.3-2.2-3 3.9-3.7 4.1-3.3 4.3-3.3-.2-4.6-.2-4.2 1-.3-1.7-1 .3.4 1.5 2.6 6.4 16.8 3.2 1-1.3-.1-2.6 1.4-2.6-.3-2.6 2.4-1.3-1.1-.8.1-4.2h2.8l-1.3-5z"
    />
    <path
      onClick={handleClick}
      id="AR"
    ...
    <path
      ...
      data-name="Armenia"
      data-id="AM"
      d="m1219 325.1-.9-4.4-2.5-1.1-2.5-1.7 1-2-3.1-2.2.7-1.5-2.2-1.1-1.4-1.7-6.9 1 1.3 2.2v3.1l4.2 1.5 2.4 1.9 1-.2 1.8 1.7h2.3l.2 1 2.8 3.7 1.8-.2z"
    />
    <path
      onClick={handleClick}
      id="AU"
    ...
    <path
      ...
      data-name="Austria"
      data-id="AT"
      d="m1060.2 264-2.3-1.2-2.3.3-4-1.9-1.7.5-2.6 2.5-3.8-2-1.5 2.9-1.7.8 1 4-.4 1.1-1.7-1.3-2.4-.2-3.4 1.2-4.4-.3-.6 1.6-2.6-1.7-1.5.3.2 1.1-.7 1.6 2.3 1.1 2.6.2 3.1.9.5-1.2 4.8-1.1 1.3 2.2 7.2 1.6 4.2.4 2.4-1.4 4.3-.1.9-1.1 1.3-4-1.1-1.3h2.8l.2-2.6-.7-2.1.3-.8z"
    />
    <path
      onClick={handleClick}
      id="AZ"
    ...
    <path
      ...
      data-name="Burundi"
      data-id="BI"
      d="m1148.2 590-.3-2.5-3-.4-1.7 3.6-3.5-.5 1.4 2.9.1 1.1 2 6.1-.1.3.6-.1 2.1-2.3 2.2-3.3 1.4-1.4v-2l-1.2-1.5z"
    />
    <path
      onClick={handleClick}
      id="BE"
      data-name="Belgium"
      data-id="BE"
      d="m1000.7 246.2-4.4 1.3-3.6-.5-3.8 1.2.7 2.2 2.2.1 2.4 2.4 3.4 2.9 2.5-.4 4.4 2.8.4-3.5 1.3-.2.4-4.2-2.8-1.4-3.1-2.7z"
    />
    <path
      onClick={handleClick}
      id="BJ"
      data-name="Benin"
      data-id="BJ"
      d="m996.9 498-4.3-3.7h-2l-1.9 1.9-1.2 1.9-2.7.6-1.2 2.8-1.9.7-.7 3.3 1.7 1.9 2 2.3.2 3.1 1.1 1.3-.2 14.6 1.4 4.4 4.6-.8.3-10.2-.1-4.1 1-4 1.7-1.9 2.7-4-.6-1.7 1.1-2.5-1.2-3.8.2-2.1z"
    />
    <path
      onClick={handleClick}
      id="BF"
    ...
    <path
      ...
      data-id="BD"
      d="m1486.5 431.9-4.5-10.1-1.5.1-.2 4-3.5-3.3 1.1-3.6 2.4-.4 1.6-5.3-3.4-1.1-5 .1-5.4-.9-1.2-4.4-2.7-.4-4.8-2.7-1.2 4.3 4.6 3.4-3.1 2.4-.8 2.3 3.7 1.7-.4 3.8 2.6 4.8 1.6 5.2 2.2.6 1.7.7.6-1.2 2.5 1.3 1.3-3.5-.9-2.6 5.1.2 2.8 3.7 1.5 3.1.8 3.2 2 3.3-1.1-5.1 2.1 1-.5-4.6z"
    />
    <path
      onClick={handleClick}
      id="BG"
      data-name="Bulgaria"
      data-id="BG"
      d="m1121.6 294.3-3-.7-4-2.2-5.8 1.4-2.3 1.6-7.5-.3-4-1-1.9.5-1.8-2.6-1.1 1.4.7 2.3 2.8 2.6-1.7 1.9-.7 2 .6.7-.7.9 2.8 2 .8 4.1 3.8.2 3.9-1.7 3.9 2.1 4.6-.6-.3-3 5-2 4.5.8-2.1-3.5 1.3-4.4 2.2-2.5z"
    />
    <path
      onClick={handleClick}
      id="BA"
      ...
      data-id="BA"
      d="m1062.2 284.9-2.3.1-1 1.3-1.9-1.4-.9 2.5 2.7 2.9 1.3 1.9 2.5 2.3 2 1.4 2.2 2.5 4.7 2.4.4-3.4 1.5-1.4.9-.6 1.2-.3.5-2.9-2.7-2.3 1-2.7h-1.8l-2.4-1.4-3.5.1-4.4-1z"
    />
    <path
      onClick={handleClick}
      id="BY"
      data-name="Belarus"
      data-id="BY"
      d="m1112.8 219.4-5.2-1.5-4.6 2.3-2.6 1 .9 2.6-3.5 2-.5 3.4-4.8 2.2h-4.6l.6 2.7 1.7 2.3.3 2.4-2.7 1.2 1.9 2.9.5 2.7 2.2-.3 2.4-1.6 3.7-.2 5 .5 5.6 1.5 3.8.1 2 .9 1.6-1.1 1.5 1.5 4.3-.3 2 .6-.2-3.1 1.2-1.4 4.1-.3-2-3.9-1.5-2 .8-.6 3.9.2 1.6-1.3-1.7-1.6-3.4-1.1.1-1.1-2.2-1.1-3.7-3.9.6-1.6-1-2.9-4.8-1.4-2.3.7-1-1.4z"
    />
    <path
      onClick={handleClick}
      id="BZ"
      data-name="Belize"
      data-id="BZ"
      d="m482.5 471.1 1.4-2.2 1-.2 1.3-1.7 1-3.2-.3-.6.9-2.3-.4-1 1.3-2.7.3-1.8h-1.1l.1-.9h-1l-2.5 3.9-.9-.8-.7.3-.1 1-.7 5-1.2 7.2h1.6z"
    />
    <path
      onClick={handleClick}
      id="BO"
    ...
    <path
      ...
      data-name="Brazil"
      data-id="BR"
      d="m659 560.1-1.4.2-3.1-.5-1.8 1.7-2.6 1.1-1.7.2-.7 1.3-2.7-.3-3.5-3-.3-2.9-1.4-3.3 1-5.4 1.6-2.2-1.2-3-1.9-.9.8-2.8-1.3-1.5-2.9.3.7 1.8-2.1 2.4-6.4 2.4-4 1-1.7 1.5-4.4-1.6-4.2-.8-1 .6 2.4 1.6-.3 4.3.7 4 4.8.5.3 1.4-4.1 1.8-.7 2.7-2.3 1-4.2 1.5-1.1 1.9-4.4.5-3-3.4-1.1.8-1-3.8-1.6-2-1.9 2.2-10.9-.1v3.9l3.3.7-.2 2.4-1.1-.6-3.2 1v4.6l2.5 2.4.9 3.6-.1 2.8-2.2 17.4-5.1-.3-.7 1-4.6 1.2-6.2 4.3-.4 3-1.3 2.2.7 3.4-3.3 1.9.1 2.7-1.5 1.1 2.6 5.8 3.3 3.8-1 2.8 3.7.3 2.3 3.4 4.9.2 4.4-3.8.2 9.7 2.6.7 3-1.1 4.2.6 2.9-.2 1.1-1.9 4.8-2.6 2.8-2.3 7.3-1.1-.4 4.7.9 2.5-.3 4.3 6.4 5.7 6.3 1 2.4 2.4 3.8 1.2 2.5 1.9 3.5-.1 3.3 1.9.5 3.7 1.2 1.8.3 2.8-1.6.1 2.7 7.4 10.7.3-.6 3.6.8 2.6 3.2 1.7 1.6 4-.5 5-1.3 2.8.8 3.6-1.6 1.3 1.9 3.6.4 8.6 6 1.2 2.1-1.2 3.9 1.7 1.2 1.9 1 5.8.9 2.5 2 .3 2-1.1 2.1 1.2.3 3.5-.3 3.8-.7 3.6 2.6-1.2 3.1 3.7.5 5.1-4.2 3.5-3.3 2.6-5.3 6.2-5.9 8.6 3.4-.7 6.2 4.9 1.9-.2 6.2 4.1 4.8 3.5 3.8 4.3-1.9 3 2.1 3.7 2.9-3.7 1.5-6 3.2-3 3.9-5 4.5-11.2 3.4-3.5.8-3.1.3-6.4-1.3-3.5.3-4.8 4.1-6.3 6-5.1 6-1.8 3.6-2.9 8.5-2.4h5.9l1.1-3.8 4.2-2.8.6-6.5 5.1-8.3.5-8.5 1.6-2.6.3-4.1 1.1-9.9-1-11.9 1.4-4.7 1.4-.1 3.9-5.5 3.3-7.2 7.7-8.8 2.7-4.2 2-10.5-1-3.9-2-8.1-2.1-2-4.8-.2-4.3-1.9-7.3-7.1-8.4-5.3-8.4.3-10.9-3.4-6.5 2 .8-3.5-2.7-3.8-9.4-3.8-7.1-2.3-4.2 4.1-.3-6.3-9.9-1-1.7-2 4.2-5.2-.1-4.4-3-1-3-11.2-1.3-3.5-1.9.3-3.5 5.8-1.8 4.7-2.1 2.4-2.7.5-.8-1.8-1.2-.3-1.8 1.8-2.4-1.3-3.2-1.4-2.7.7-2.3-.6-.5 1.8.9 1.3-.5 1.3-3.1-.5z"
    />
    <path
      onClick={handleClick}
      id="BN"
      data-name="Brunei"
      data-id="BN"
      d="m1617.8 543.4 2.7 3.3 1.1-2.2 2.7.2.1-4.1.1-3.1-4.6 3.5-2.1 2.4z"
    />
    <path
      onClick={handleClick}
      id="BT"
      data-name="Bhutan"
      data-id="BT"
      d="m1474.7 395.5-2.7-1.8-2.9-.1-4.2-1.5-2.6 1.6-2.6 4.8.3 1.2 5.5 2.5 3.2-1 4.7.4 4.4-.2-.4-3.9-2.7-2z"
    />
    <path
      onClick={handleClick}
      id="BW"
      data-name="Botswana"
      data-id="BW"
      d="m1116.7 685-1-.5-3.2 1.5h-1.6l-3.7 2.5-2-2.6-8.6 2.2-4.1.2-.9 22.7-5.4.2-.6 18.5 1.4 1 3 6.1-.7 3.8 1.1 2.3 4-.7 2.8-2.8 2.7-1.9 1.5-3.1 2.7-1.5 2.3.8 2.5 1.8 4.4.3 3.6-1.5.6-2 1.2-3 3-.5 1.7-2.4 2-4.3 5.2-4.7 8-4.7-3.4-2.9-4.2-.9-1.5-4.1.1-2.2-2.3-.7-6-7-1.6-3.7-1.1-1.1-1.9-5.1z"
    />
    <path
      onClick={handleClick}
      id="CF"
      ...
      data-id="CF"
      d="m1110.5 517.3-.5-.3-2-1.8-.3-2 .8-2.6V508l-3.3-4-.7-2.7-3.5 1.1-2.8 2.5-4 7-5.2 2.9-5.4-.4-1.6.6.6 2.3-2.9 2.2-2.3 2.5-7.1 2.4-1.4-1.4-.9-.2-1 1.7-4.7.4-2.7 6.5-1.4 1.1-.4 5 .6 2.7-.4 1.9 2.6 3.3.5 2.3 2.1 3.2 2.6 2.1.3 2.9.6 1.8 2.9-5.9 3.3-3.4 3.8 1.1 3.6.4.5-4.5 2.2-3.2 3-2 4.6 2.1 3.6 2.4 4.1.6 4.2 1.2 1.6-3.8.8-.5 2.6.6 6.2-3.1 2.2 1.3 1.8-.2.9-1.5 2-.6 4.3.7 3.6.1 1.8-.6-.9-2.1-4.2-2.5-1.5-3.8-2.4-2.7-3.8-3.4-.1-2-3.1-2.6-3.8-2.5z"
    />
    <path
      onClick={handleClick}
      id="CA"
    ...
    <path
      ...
      data-id="CH"
      d="m1024.3 270.6-5.4-1.9-1 1.4h-4.2l-1.3 1-2.3-.6.2 1.6-3.5 3.5v2.8l2.4-.9 1.8 2.7 2.2 1.3 2.4-.3 2.7-2.1.9 1 2.4-.2.9-2.5 3.8.8 2.1-1.1.3-2.5-2.6-.2-2.3-1.1.7-1.6-.2-1.1z"
    />
    <path
      onClick={handleClick}
      id="CL"
    ...
    <path
      ...
      data-id="CR"
      d="m509.1 502.6-1.4 1.3-1.7-.4-.8-1.3-1.7-.5-1.4.8-3.5-1.7-.9.8-1.4 1.2 1.5.9-.9 2-.1 2 .7 1.3 1.7.6 1.2 1.8 1.2-1.6-.3-1.8 1.4 1.1.3 1.9 1.9.8 2.1 1.3 1.5 1.5.1 1.4-.7 1.1 1.1 1.3 2.9 1.4.4-1.2.5-1.3-.1-1.2.8-.7-1.1-1 .1-2.5 2.2-.6-2.4-2.7-2-2.6-1.2-3.4z"
    />
    <path
      onClick={handleClick}
      id="CU"
      data-name="Cuba"
      data-id="CU"
      d="m539 427.3-4.9-2.1-4.3-.1-4.7-.5-1.4.7-4.2.6-3 1.3-2.7 1.4-1.5 2.3-3.1 2 2.2.6 2.9-.7.9-1.6 2.3-.1 4.4-3.3 5.4.3-2.3 1.6 1.8 1.3 7 1 1.5 1.3 4.9 1.7 3.2-.2.8 3.6 1.7 1.8 3.5.4 2.1 1.7-4.1 3.5 7.9-.6 3.8.5 3.7-.3 3.8-.8.8-1.5-3.9-2.6-4-.3.6-1.7-3.1-1.3h-1.9l-3-2.8-4.2-4-1.8-1.5-5.2.8-1.9-2.4z"
    />
    <path
      onClick={handleClick}
      id="CZ"
      data-name="Czech Rep."
      data-id="CZ"
      d="m1049.4 248.5-2.1.6-1.4-.7-1.1 1.2-3.4 1.2-1.7 1.5-3.4 1.3 1 1.9.7 2.6 2.6 1.5 2.9 2.6 3.8 2 2.6-2.5 1.7-.5 4 1.9 2.3-.3 2.3 1.2.6-1.4 2.2.1 1.6-.6.1-.6.9-.3.2-1.4 1.1-.3.6-1.1h1.5l-2.6-3.1-3.6-.3-.7-2-3.4-.6-.6 1.5-2.7-1.2.1-1.7-3.7-.6-2.4-1.9z"
    />
    <path
      onClick={handleClick}
      id="DE"
    ...
    <path
      ...
      data-name="Djibouti"
      data-id="DJ"
      d="m1217.8 499.2-2.5-1.7 3.1-1.5.1-2.7-1.4-1.9-1.6 1.5-2.4-.5-1.9 2.8-1.8 3 .5 1.7.2 2 3.1.1 1.3-.5 1.3 1.1 2-3.4z"
    />
    <path
      onClick={handleClick}
      id="DK"
      data-name="Denmark"
      data-id="DK"
      d="m1035.9 221.2-1.7-3-6.7 2 .9 2.5 5.1 3.4 2.4-4.9zm-8.6-5.1-2.6-.9-.7-1.6 1.3-2-.1-3-3.6 1.6-1.5 1.7-4 .4-1.2 1.7-.7 1.6.4 6.1 2.1 3.4 3.6.8 3-.9-1.5-3 3.1-4.3 1.4.7 1-2.3z"
    />
    <path
      onClick={handleClick}
      id="DO"
    ...
    <path
      ...
      data-name="Ecuador"
      data-id="EC"
      d="m553.1 573.1-2.4-1.5-2.8-2.1-1.6 1-4.7-.9-1.4-2.7-1 .1-5.6-3.6-3.9 2.5-3.1 1.4.4 2.6-2.2 4.1-1 3.9-1.9 1 1 5.8-1.1 1.8 3.4 2.7 2.1-2.9 1.3 2.8-2.9 4.7.7 2.7-1.5 1.5.2 2.3 2.3-.5 2.3.7 2.5 3.2 3.1-2.6.9-4.3 3.3-5.5 6.7-2.5 6-6.7 1.7-4.1-.8-4.9z"
    />
    <path
      onClick={handleClick}
      id="EG"
      data-name="Egypt"
      data-id="EG"
      d="m1129.7 374.8-5.5-1.9-5.3-1.7-7.1.2-1.8 3 1.1 2.7-1.2 3.9 2 5.1 1.3 22.7 1 23.4h65.3l-1-1.3-6.8-5.7-.4-4.2 1-1.1-5.3-7-2-3.6-2.3-3.5-4.8-9.9-3.9-6.4-2.8-6.7.5-.6 4.6 9.1 2.7 2.9 2 2 1.2-1.1 1.2-3.3.7-4.8 1.3-2.5-.7-1.7-3.9-9.2-2.5 1.6-4.2-.4-4.4-1.5-1.1 2.1-1.7-3.2-3.9-.8-4.7.6-2.1 1.8-3.9 2-2.6-1z"
    />
    <path
      onClick={handleClick}
      id="ER"
      data-name="Eritrea"
      data-id="ER"
      d="m1198.1 474-3.2-3.1-1.8-5.9-3.7-7.3-2.6 3.6-4 1-1.6 2-.4 4.2-1.9 9.4.7 2.5 6.5 1.3 1.5-4.7 3.5 2.9 3.2-1.5 1.4 1.3 3.9.1 4.9 2.5 1.6 2.2 2.5 2.1 2.5 3.7 2 2.1 2.4.5 1.6-1.5-2.8-1.9-1.9-2.2-3.2-3.7-3.2-3.6-7.9-6z"
    />
    <path
      onClick={handleClick}
      id="EE"
      data-name="Estonia"
      data-id="EE"
      d="m1093.2 197.5-5.5.9-5.4 1.6.9 3.4 3.3 2.1 1.5-.8.1 3.5 3.7-1 2.1.7 4.4 2.2h3.8l1.6-1.9-2.5-5.5 2.6-3.4-.9-1-4.6.2-5.1-1z"
    />
    <path
      onClick={handleClick}
      id="ET"
    ...
    <path
      ...
      data-name="Finland"
      data-id="FI"
      d="m1093.4 144.4.8-3.8-5.7-2.1-5.8 1.8-1.1 3.9-3.4 2.4-4.7-1.3-5.3.3-5.1-2.9-2.1 1.4 5.9 2.7 7.2 3.7 1.7 8.4 1.9 2.2 6.4 2.6.9 2.3-2.6 1.2-8.7 6.1-3.3 3.6-1.5 3.3 2.9 5.2-.1 5.7 4.7 1.9 3.1 3.1 7.1-1.2 7.5-2.1 8-.5 7.9-7.4 3.3-3.3.9-2.9-7.3-3.9.9-3.7-4.9-4.1 1.7-4.8-6.4-6.3 2.8-4.1-7.2-3.7-.4-3.7z"
    />
    <path
      onClick={handleClick}
      id="FJ"
      data-name="Fiji"
      data-id="FJ"
      d="m1976.7 674.4-3.7 2-1.9.3-3.1 1.3.2 2.4 3.9-1.3 3.9-1.6.7-3.1zm-11 8.1-1.6 1-2.3-.8-2.7 2.2-.2 2.8 2.9.8 3.6-.9 1.8-3.3-1.5-1.8z"
    />
    <path
      onClick={handleClick}
      id="GA"
      data-name="Gabon"
      data-id="GA"
      d="m1050.2 557.7-.7-.3-3.4.8-3.4-.8-2.6.4v7.6h-8.2l-1.9.3-1.1 4.8-1.3 4.6-1.3 2-.2 2.1 3.4 6.6 3.7 5.3 5.8 6.4 4.3-3.5-2.1-4.2 1.9-1.6 3.8-.8.5-2.8 3 3 4.9.3 1.7-3 .8-4.3-.6-4.9-2.7-3.8 2.4-7.4-1.4-1.2-4.2.5-1.5-3.3.4-2.8z"
    />
    <path
      onClick={handleClick}
      id="GB"
    ...
    <path
      ...
      data-name="Georgia"
      data-id="GE"
      d="m1200 300.2-7.5-2.9-7.7-1-4.5-1.1-.5.7 2.2 1.9 3 .7 3.4 2.3 2.1 4.2-.3 2.7 5.4-.3 5.6 3 6.9-1 1.1-1 4.2 1.8 2.8.4.6-.7-3.2-3.4 1.1-.9-3.5-1.4-2.1-2.5-5.1-1.3-2.9 1-1.1-1.2z"
    />
    <path
      onClick={handleClick}
      id="GH"
      data-name="Ghana"
      data-id="GH"
      d="m976.8 502.1-2.6-.5-1.8 1-2.4-.5-9.7.3-.2 3.6.8 4.8 1.4 9.1-2.3 5.3-1.5 7.2 2.4 5.5-.2 2.5 5 1.8 5-1.9 3.2-2.1 8.7-3.8-1.2-2.2-1.5-4-.4-3.2 1.2-5.7-1.4-2.3-.6-5.1.1-4.6-2.4-3.3.4-1.9z"
    />
    <path
      onClick={handleClick}
      id="GN"
    ...
    <path
      ...
      data-name="Gambia"
      data-id="GM"
      d="m882.8 488.5 5 .1 1.4-.9h1l2.1-1.5 2.4 1.4 2.4.1 2.4-1.5-1.1-1.8-1.8 1.1-1.8-.1-2.1-1.5-1.8.1-1.3 1.5-6.1.2-.7 2.8z"
    />
    <path
      onClick={handleClick}
      id="GW"
      ...
      data-id="GW"
      d="m900.2 492.1-10.3-.3-1.5.7-1.8-.2-3 1.1.3 1.3 1.7 1.4v.9l1.2 1.8 2.4.5 2.9 2.6 2.6-3.1 1.7.1 1.4-1h1.3l.8-.9-.4-2.1.6-.7.1-2.1z"
    />
    <path
      onClick={handleClick}
      id="GQ"
      data-name="Eq. Guinea"
      data-id="GQ"
      d="m1040.1 557.8-9.2-.2-1.9 7.2 1 .9 1.9-.3h8.2v-7.6z"
    />
    <path
      onClick={handleClick}
      id="GR"
    ...
    <path
      ...
      data-name="Guatemala"
      data-id="GT"
      d="m482.8 458.9-5.1-.1h-5.2l-.4 3.6h-2.6l1.8 2.1 1.9 1.5.5 1.4.8.4-.4 2.1H467l-3.3 5.2.7 1.2-.8 1.5-.4 1.9 2.7 2.6 2.5 1.3 3.4.1 2.8 1.1.2-1 2.1-1.6 1.1-.7-.2-.7 1.4-.4 1.3-1.6-.3-1.3.5-1.2 2.8-1.8 2.8-2.4-1.5-.8-.6.9-1.7-1.1h-1.6l1.2-7.2.7-5z"
    />
    <path
      onClick={handleClick}
      id="GY"
      data-name="Guyana"
      data-id="GY"
      d="m656.1 534.2-2.1-2.3-2.9-3.1-2.1-.1-.1-3.3-3.3-4.1-3.6-2.4-4.6 3.8-.6 2.3 1.9 2.3-1.5 1.2-3.4 1.1v2.9l-1.6 1.8 3.7 4.8 2.9-.3 1.3 1.5-.8 2.8 1.9.9 1.2 3-1.6 2.2-1 5.4 1.4 3.3.3 2.9 3.5 3 2.7.3.7-1.3 1.7-.2 2.6-1.1 1.8-1.7 3.1.5 1.4-.2-3.3-5.6-.7-3.5-1.8-.1-2.4-4.6 1.1-3.3-.3-1.5 3.5-1.6 1-5.7z"
    />
    <path
      onClick={handleClick}
      id="HN"
      data-name="Honduras"
      data-id="HN"
      d="m514.1 476.8-1.3-1.8-1.9-1-1.5-1.4-1.6-1.2-.8-.1-2.5-.9-1.1.5-1.5.2-1.3-.4-1.7-.4-.8.7-1.8.7-2.6.2-2.5-.6-.9.4-.5-.6-1.6.1-1.3 1.1-.6-.2-2.8 2.4-2.8 1.8-.5 1.2.3 1.3-1.3 1.6 1.5.5 1.1 1.3 1.6 1 .1.9 2.5-.8 1.1.5.7.7-.6 2.5 1.7.6.7 2 1.8-.3.8-1.5h.8l.2-3.1 1.3-.2h1.2l1.4-1.7 1.5 1.3.6-.8 1.1-.7 2.1-1.8.3-1.3.5.1.8-1.5.6-.2.9.9 1.1.3 1.3-.8h1.4l2-.8.9-.9 1.9.2z"
    />
    <path
      onClick={handleClick}
      id="HR"
      data-name="Croatia"
      data-id="HR"
      d="m1065 280.4-4-2.6-1.6-.8-3.9 1.7-.3 2.5-1.7.6.2 1.7-2-.1-1.8-1-.8 1-3.5-.2-.2.1v2.2l1.7 2 1.3-2.6 3.3 1 .3 2 2.5 2.6-1 .5 4.6 4.5 4.8 1.8 3.1 2.2 5 2.3.5-1-4.7-2.4-2.2-2.5-2-1.4-2.5-2.3-1.3-1.9-2.7-2.9.9-2.5 1.9 1.4 1-1.3 2.3-.1 4.4 1 3.5-.1 2.4 1.4 1.7-2.3-1.7-1.8-1.5-2.4-1.8.9-4.2-1.2z"
    />
    <path
      onClick={handleClick}
      id="HT"
      data-name="Haiti"
      data-id="HT"
      d="m580.6 446.7-4.6-1-3.4-.2-1.4 1.7 3.4 1-.3 2.4 2.2 2.8-2.1 1.4-4.2-.5-5-.9-.7 2.1 2.8 1.9 2.7-1.1 3.3.4 2.7-.4 3.6 1.1.2-1.8-1.2-1.9 1.5-1.1.7-2.4-.2-3.5z"
    />
    <path
      onClick={handleClick}
      id="HU"
      data-name="Hungary"
      data-id="HU"
      d="m1079.1 263.8-1.6.4-1 1.5-2.2.7-.6-.4-2.3 1-1.9.2-.3 1.2-4.1.8-1.9-.7-2.6-1.6-.2 2.6h-2.8l1.1 1.3-1.3 4 .8.1 1.2 2.1 1.6.8 4 2.6 4.2 1.2 1.8-.9 3.7-1.6 3.2.2 3.8-1.1 2.6-4.3 1.9-4.2 2.9-1.3-.6-1.6-2.9-1.7-1 .6-5.5-1.9z"
    />
    <path
      onClick={handleClick}
      id="ID"
    ...
    <path
      ...
      data-name="Ireland"
      data-id="IE"
      d="m947.3 231.7-3.5-1.3-2.9.1 1.1-3.2-.8-3.2-3.7 2.8-6.7 4.7 2.1 6.1-4.2 6.4 6.7.9 8.7-3.6 3.9-5.4-.7-4.3z"
    />
    <path
      onClick={handleClick}
      id="IR"
    ...
    <path
      ...
      data-name="Iraq"
      data-id="IQ"
      d="m1207.3 334.9-6.2-.9-2.1 1-2.1 4.1-2.7 1.6 1.2 4.7-.9 7.8-11 6.7 3.1 7.7 6.7 1.7 8.5 4.5 16.7 12.7 10.2.5 3.2-6.1 3.7.5 3.2.4-3.4-3.4-.5-3.3h-1.7l.2-4.6-3.5-4.9-7-3.4-4.6-6.1.5-5 2.3-2.2-1-3.8-3.7-1.9-4.7-7.8-2.3 1.1-2.1-1.6z"
    />
    <path
      onClick={handleClick}
      id="IS"
      data-name="Iceland"
      data-id="IS"
      d="m915.7 158.6-6.9-.4-7.3 2.9-5.1-1.5-6.9 3-5.9-3.8-6.5.8-3.6 3.7 8.7 1.3-.1 1.6-7.8 1.1 8.8 2.7-4.6 2.5 11.7 1.8 5.6.8 3.9-1 12.9-3.9 6.1-4.2-4.4-3.8 1.4-3.6z"
    />
    <path
      onClick={handleClick}
      id="IL"
      data-name="Israel"
      data-id="IL"
      d="m1167.8 360.5-1.4.1-.4 1.1h-1.8l-.1.1-.6 1.6-.6 4.8-1.1 2.9.4.4-1.4 2.1 3.9 9.2.7 1.7 1.7-10.2-.4-2.4-2.4.8.1-1.7 1.2-.8-1.4-.7.7-4.3 2 .9.7-2h-.1l.6-1-.3-2.6z"
    />
    <path
      onClick={handleClick}
      id="IT"
    ...
    <path
      ...
      data-name="Jamaica"
      data-id="JM"
      d="m550.7 458.5 3.9-.1-.8-1.8-2.7-1.5-3.7-.6-1.2-.2-2.4.4-.8 1.5 2.9 2.3 3 1 1.8-1z"
    />
    <path
      onClick={handleClick}
      id="JO"
      data-name="Jordan"
      data-id="JO"
      d="m1186.6 367.6-3.1-7.7-9.6 6.7-6.3-2.5-.7 2 .4 3.9-.6 1.9.4 2.4-1.7 10.2.3.9 6.1 1 2.1-2 1.1-2.3 4-.8.7-2.2 1.7-1-6.1-6.4 10.4-3.1.9-1z"
    />
    <path
      onClick={handleClick}
      id="JP"
    ...
    <path
      ...
      data-id="KG"
      d="m1387.2 302.6-3.5-.9-3.3-2.2-7.8-.6-8.6-.2-1.6.7-8.1-2.6-2.5 1.3.5 3.6-9.1-2.1-3.1.8-.3 2.7 1.8.6-3.1 4.1 4.6 2.3 3.2-1.6 7.1 3.3-5.2 4.5-4.1-.6-1.4 2-5.9-1.1.6 3.7 5.4-.5 7.1 2 9.5-.9 1-1.5-1.1-1.5 4-3 3.2-1.2 5.7.9.6-4 6.4-.8 1-2.4 6.8-3.4.2-1.4z"
    />
    <path
      onClick={handleClick}
      id="KH"
      data-name="Cambodia"
      data-id="KH"
      d="m1574.8 481.8-5.2-2.3-2 4.3-4.9-2.4-5.3-1-7.1 1.3-3 5.2 2.1 7.7 3.4 6.6 2.6 3.3 4.7.9 4.7-2.5 5.8-.5-2.8-3.8 8.9-4.9-.1-7.7-1.8-4.2z"
    />
    <path
      onClick={handleClick}
      id="KR"
      data-name="Korea"
      data-id="KR"
      d="m1637.3 331.7 6.2 5.5-3.4 1.1 5.2 6.8 1.1 4.8 2.1 3.5 4.5-.5 3.2-2.7 4.2-1.2.5-3.6-3.4-7.5-3.3-4.2-8.2-7.6.1 1.6-2.1.4-3.5.3-.7 2.9-2.4-.2-.1.6z"
    />
    <path
      onClick={handleClick}
      id="KW"
      data-name="Kuwait"
      data-id="KW"
      d="m1235.6 381.4-3.7-.5-3.2 6.1 4.9.6 1.7 3.1 3.8-.2-2.4-4.8.3-1.5-1.4-2.8z"
    />
    <path
      onClick={handleClick}
      id="LA"
      data-name="Lao PDR"
      data-id="LA"
      d="m1574.8 481.8.2-6.4-2-4.5-4.8-4.4-4.3-5.6-5.7-7.5-7.3-3.8 1.3-2.3 3.3-1.7-3-5.5-6.8-.1-3.4-5.7-4-5.1-2.7 1 1.9 7.2-2.9-.1-.7-1.5-4.1 4.1-.8 2.4 2.6 1.9.9 3.8 3.8.3-.4 6.7 1 5.7 5.3-3.8 1.8 1.2 3.2-.2.8-2.2 4.3.4 4.9 5.2 1.3 6.3 5.2 5.5.5 5.4-1.5 2.9 4.9 2.4 2-4.3 5.2 2.3z"
    />
    <path
      onClick={handleClick}
      id="LB"
      data-name="Lebanon"
      data-id="LB"
      d="m1167.8 360.5.9-3.5 2.6-2.4-1.2-2.5-2.4-.3-.1.2-2.1 4.5-1.3 5.2h1.8l.4-1.1 1.4-.1z"
    />
    <path
      onClick={handleClick}
      id="LR"
      data-name="Liberia"
      data-id="LR"
      d="m929.4 523.3-1.6-.2-1.1 2.6-1.6-.1-1.1-1.3.4-2.6-2.3-3.9-1.5.7-1.2.2-2.6 3-2.6 3.4-.3 1.9-1.3 2 3.7 4.1 4.8 3.5 5.1 4.8 5.7 3.1 1.5-.1.5-5.2.5-.8-.2-2.5-2.3-2.7-1.8-.4-1.6-1.8 1.2-2.8-.6-3.1.3-1.8z"
    />
    <path
      onClick={handleClick}
      id="LY"
    ...
    <path
      ...
      data-name="Sri Lanka"
      data-id="LK"
      d="m1432.2 532.7 2.3-1.8.6-6.6-3-6.6-2.9-4.5-4.1-3.5-1.9 10.3 1.4 9.1 2.8 5.1 4.8-1.5z"
    />
    <path
      onClick={handleClick}
      id="LS"
      data-name="Lesotho"
      data-id="LS"
      d="m1128.1 766.5 1.1-2 3.1-1 1.1-2.1 1.9-3.1-1.7-1.9-2.3-2-2.6 1.3-3.1 2.5-3.2 4 3.7 4.9 2-.6z"
    />
    <path
      onClick={handleClick}
      id="LT"
      data-name="Lithuania"
      data-id="LT"
      d="m1100.4 221.2-5-2.9-2.5-.4-.9-1.3-4.4.6-7.9-.4-5 1.9 1.7 5 5 1.1 2.2.9-.2 1.7.6 1.5 2.5.6 1.4 1.9h4.6l4.8-2.2.5-3.4 3.5-2-.9-2.6z"
    />
    <path
      onClick={handleClick}
      id="LU"
      ...
      data-id="LU"
      d="m1007 258.6.2-2.7-1-1.4-1.3.2-.4 3.5 1.1.5 1.4-.1z"
    />
    <path
      onClick={handleClick}
      id="LV"
    ...
    <path
      ...
      data-name="Moldova"
      data-id="MD"
      d="m1118.5 283.3 1.2-.7.5-2.1 1.1-2-.5-1.1 1-.5.6.9 3 .2 1.2-.5-1-.6.2-1-2-1.5-1.1-2.6-1.9-1.1v-2.1l-2.5-1.6-2-.3-3.9-1.9-3.2.6-1.1.9 1.6.6 1.8 1.9 1.9 2.6 3.4 3.7.6 2.7-.2 2.7 1.3 2.8z"
    />
    <path
      onClick={handleClick}
      id="MG"
    ...
    <path
      ...
      data-name="Macedonia"
      data-id="MK"
      d="m1094 304.8-2.8-2-2.4.1-1.7.4-1.1.2-2.9 1-.1 1.2h-.7l-.4 2.1.9 2.6 2.3 1.6 3.3-.6 1.9-1.3 2.8.1.7-1.1 1-.2-.8-4.1z"
    />
    <path
      onClick={handleClick}
      id="ML"
    ...
    <path
      ...
      data-id="ME"
      d="m1080 299.8.4-.6-2-1.2-1.8-.7-.8-.8-1.5-1.1-.9.6-1.5 1.4-.4 3.4-.5 1 2.3 1.2 1.6 2.1 1.1.4-.5-1.9 2-3.1.4 1.2 1.3-.5.8-1.4z"
    />
    <path
      onClick={handleClick}
      id="MN"
      data-name="Mongolia"
      data-id="MN"
      d="m1473.7 252.1-3.7-4.6-6.6-1.5-4.8-.8-6.9-2.5-1.3 6.4 4 3.6-2.4 4.3-7.9-1.6-5-.2-4.7-2.9-5.1-.1-5.3-1.9-5.9 2.9-6.6 5.4-4.7 1 3.3 4.4 5.7 3.3 8.1 2.3 5.8 5 1.3 7.3 3 2.7 6.4 1 7.2.9 7.9 3.8 3.4.7 4.9 5.7 4.7 3.6 5.5-.1 11.2 1.3 6.4-.8 5.5.9 9.3 3.8 6.2-.1 3.2 2 4.4-3.3 7.2-2.2 7.5-.2 4.9-2.2 1.9-3.3 2.5-2-1.9-2.1-2.9-2.3.4-4 3.2.5 5.9 1.3 3.1-3.3 6.3-2.4 1.4-4.1 2.4-1.8 6.8-.8 4.3.7-.7-2.2-7.2-4.3-5.1-2-2.5 2.3-5.4-1-2.4.8-2.7-2.6-.3-6.2-.6-4.6-5.5.5-3.9-2.1-3.3-.7-4.5 4.4-5.8 1-3.6 1.6-6.7-1h-4.5l-4.9-3.1-6.5-3-5.4-.8-5.7.8-3.9 1.1-8.4-2.6z"
    />
    <path
      onClick={handleClick}
      id="MZ"
    ...
    <path
      ...
      data-id="MR"
      d="m949.8 413.3-20.3-15.5-.2 9.7-17.9-.3-.2 16.3-5.2.5-1.4 3.3.9 9.2-21.6-.1-1.2 2.2 2.8 2.7 1.4 3-.7 3.2.6 3.2.5 6.3-.8 5.9-1.7 3.2.4 3.4 2-2 2.7.5 2.8-1.4h3.1l2.6 1.8 3.7 1.7 3.2 4.7 3.6 4.4 1.9-1.2 1-3.7 1.8-.2 3.8 1.8 3.2-1.3 2.1.4.9-1.4 22.3-.1 1.3-4.4-1-.8-2.4-27.5-2.4-27.4 8.4-.1z"
    />
    <path
      onClick={handleClick}
      id="MW"
      data-name="Malawi"
      data-id="MW"
      d="m1169.2 661.5.1-2.3-1.2-1.9.1-2.8-1.5-4.7 1.7-3.5-.1-7.7-1.9-4.1.2-.7-1.1-1.7-5.4-1.2 2.6 2.8 1.2 5.4-1 1.8-1.2 5.1.9 5.3-1.8 2.2-1.9 5.9 2.9 1.7 3 3 1.6-.6 2.1 1.6.3 2.6-1.3 2.9.2 4.5 3.4 4 1.9-4.5 2.5-1.3-.1-8.2-2.2-4.6-1.9-2h-.3v.8l1.1.3 1 3.4-.2.8-1.9-2.5-1 1.6-.8-1.4z"
    />
    <path
      onClick={handleClick}
      id="MY"
    ...
    <path
      ...
      data-name="Nepal"
      data-id="NP"
      d="m1455.2 394.8-6.5-.6-6.4-1.5-5-2.8-4.5-1.2-2.5-3.1-3.2-.9-6.4-4.1-4.7-2-1.9 1.5-2.8 2.9-.9 5.9 5.7 2.5 5.8 3.1 7.7 3.5 7.6.9 3.8 3.2 4.3.6 6.8 1.5 4.6-.1.1-2.5-1.5-4.1-.1-2.7z"
    />
    <path
      onClick={handleClick}
      id="NZ"
      ...
      data-id="NZ"
      d="m1868.6 832.8.9-2.6-5.8 2.9-3.4 3.4-3.2 1.6-5.9 4.6-5.6 3.2-7 3.2-5.5 2.4-4.3 1.1-11.3 6.1-6.4 4.6-1.1 2.3 5.1.4 1.5 2.1 4.5.1 4-1.8 6.3-2.8 8.1-6.2 4.7-4.1 6.2-2.3 4-.1.6-2.9 4.6-2.5 7-4.5 4.2-2.9 2.1-2.6.5-2.6-5.6 2.5.8-2.6zm28.8-30.5 1.9-5.7-3.1-1.7-.8-3.6-2.3.5-.4 4.6.8 5.7.9 2.7-.9 1.1-.6 4.4-2.4 4.1-4.2 5-5.3 2.2-1.7 2.4 3.7 2.5-.8 3.5-6.9 5.1 1.4.9-.4 1.6 5.9-2.5 5.9-4.2 4.5-3.4 1.6-1.2 1.5-2.7 2.8-2 3.8.2 4.2-3.8 5.1-5.7-2.1-.8-4.6 2.5-3.2-.5-2.9-2.1 2.3-4.9-1.2-1.8-2.9 4.4.4-6.8z"
    />
    <path
      onClick={handleClick}
      id="OM"
      data-name="Oman"
      data-id="OM"
      d="m1301 437.8 2.1-2 .8-1.8 1.6-3.8-.1-1.4-2.1-.8-1.6-2.1-2.9-3.7-3.3-1.1-4.1-.9-3.3-2.3-2.9-4.3h-2.8l-.1 4.2 1.1.8-2.4 1.3.3 2.6-1.4 2.6.1 2.6 2.9 4.5-2.6 12.7-16.1 6.4 5.2 10.5 2.1 4.4 2.5-.3 3.6-2.2 3.1.6 2.5-1.8-.2-2.5 2.1-1.6h3.4l1.2-1.3.2-3.1 3.3-2.4h2.6l.4-.8-1-4.2.6-3.2 1-1.5 2.5.3 1.7-4.4zm-16.6-30.4.2-2.6-.7-.6-1.3 2.2 1.3 2.2.5-1.2z"
    />
    <path
      onClick={handleClick}
      id="PK"
    ...
    <path
      ...
      data-name="Panama"
      data-id="PA"
      d="m543.5 517-2-1.8-1.7-1.9-2.5-1.1-3.1-.2.3-.6-3.1-.4-2 1.9-3.5 1.3-2.5 1.6-2.7.5-1.5-1.6-.5.5-2.3-.3.2-1.3-1.9-2.3-2.2.6-.1 2.5 1.1 1-.8.7.1 1.2-.5 1.3-.4 1.2.6 1 .3-1.4h2.4l1.4.7 2.3.5 1 2.5 1.8.4.8-1.1.8 3.8 2.6-.3.9-.9 1.5-.9-2.5-3.4.6-1.3 1.3-.3 2.3-1.6 1.2-2.2 2.5-.4 2.7 1.8 1 2.1 1.4.4-1.5 1.7 1 3.5 1.8 1.8.9-3.1 1.8.5 1.1-1.9-1.1-3.8.7-.9z"
    />
    <path
      onClick={handleClick}
      id="PE"
    ...
    <path
      ...
      data-id="KP"
      d="m1644.7 302.3-5.5-3.6.1 3.5-6.3 2.6 2.7 3.3-4.6-.2-3.6-2-1 4.4-3.8 3.4-2.1 4 3.3 1.7 3.4.7.8 1 .4 3.5 1.1 1.2-.9.7-.1 2.9 1.9 1 1.6.6.8 1.2 1.3-.5v-1.3l3.1 1.3.1-.6 2.4.2.7-2.9 3.5-.3 2.1-.4-.1-1.6-4.3-2.8-2.6-1 .2-.7-1.2-2.8 1.3-1.7 2.9-1 1-1.9.3-1.1 1.9-1.4-2.8-4.5.3-2.1.9-2 2.2.3-1.4-1.1z"
    />
    <path
      onClick={handleClick}
      id="PT"
      data-name="Portugal"
      data-id="PT"
      d="m937.6 335.9-.4-2.1 2-2.5.8-1.7-1.8-1.9 1.6-4.3-2-3.8 2.2-.5.3-3 .9-.9.2-4.9 2.4-1.7-1.3-3.1-3-.2-.9.8h-3l-1.2-3.1-2.1.9-1.9 1.6.1 2.1.9 2.2.1 2.7-1.3 3.8-.4 2.5-2.2 2.3-.6 4.2 1.2 2.4 2.3.6.4 4-1 5.1 2.8-.7 2.7.9 2.2-1.7z"
    />
    <path
      onClick={handleClick}
      id="PY"
      data-name="Paraguay"
      data-id="PY"
      d="m655.7 700.5-.3-1.9-5.4-3.3-5.1-.1-9.5 1.9-2.1 5.6.2 3.4-1.5 7.6 11.2 10.4 4.6 1 7.2 4.7 5.9 2.5 1.1 2.8-4.2 9.6 5.7 1.8 6.2 1 4.2-1.1 4.3-4.8.3-5.7.7-3.6.3-3.8-.3-3.5-2.1-1.2-2 1.1-2-.3-.9-2.5-1-5.8-1.2-1.9-3.9-1.7-2.1 1.2-6-1.2-.4-8.6-1.9-3.6z"
    />
    <path
      onClick={handleClick}
      id="PS"
      data-name="Palestine"
      data-id="PS"
      d="m1166.9 366.1-2-.9-.7 4.3 1.4.7-1.2.8-.1 1.7 2.4-.8.6-1.9-.4-3.9z"
    />
    <path
      onClick={handleClick}
      id="QA"
      data-name="Qatar"
      data-id="QA"
      d="m1258 415.5.8-3.8-.5-3.7-1.9-2-1.4.7-1.1 3.3.8 4.7 1.8 1.2 1.5-.4z"
    />
    <path
      onClick={handleClick}
      id="RO"
    ...
    <path
      ...
      data-name="Rwanda"
      data-id="RW"
      d="m1147.6 579.4-3.3 1.9-1.4-.6-1.6 1.8-.2 3.8-.8.4-.6 3.5 3.5.5 1.7-3.6 3 .4 1.6-.8.4-3.7-2.3-3.6z"
    />
    <path
      onClick={handleClick}
      id="EH"
    ...
    <path
      ...
      data-id="SA"
      d="m1228.7 387-10.2-.5-16.7-12.7-8.5-4.5-6.7-1.7-.9 1-10.4 3.1 6.1 6.4-1.7 1-.7 2.2-4 .8-1.1 2.3-2.1 2-6.1-1-.5 2.5v2.2l-.6 3.5h2.7l3.2 4.4 3.7 5.1 2.5 4.7 1.7 1.5 1.7 3.3-.2 1.4 2.1 3.7 3 1.3 2.8 2.5 3.6 7v3.8l.9 4.4 4 6.1 2.5 1 4.1 4.4 1.9 5.2 3.2 5.3 3 2.3.6 2.5 1.8 1.9.9 2.8 2.3-2.1-.7-2.7 1.2-3.1 2.4 1.7 1.5-.6 6.4-.2 1 .7 5.4.6 2.1-.3 1.6 2.1 2.5-1 3.5-6.7 5-2.9 15.7-2.4 16.1-6.4 2.6-12.7-2.9-4.5-1 1.3-16.8-3.2-2.6-6.4-.4-1.5-1.2-2.4-1.5.4-1.8-1.2-1-1.6-.9-2.1-1.7-1.8-1-2.1.4-2.1-.6-2.7-4-2.6-1.2-2.3-2.9-1.4-2.7-5.5-3.8.2-1.7-3.1-4.9-.6z"
    />
    <path
      onClick={handleClick}
      id="SD"
    ...
    <path
      ...
      data-name="Senegal"
      data-id="SN"
      d="m908.9 479.2-3.6-4.4-3.2-4.7-3.7-1.7-2.6-1.8h-3.1l-2.8 1.4-2.7-.5-2 2-1.3 3.3-2.8 4.4-2.5 1.2 2.7 2.3 2.2 5 6.1-.2 1.3-1.5 1.8-.1 2.1 1.5 1.8.1 1.8-1.1 1.1 1.8-2.4 1.5-2.4-.1-2.4-1.4-2.1 1.5h-1l-1.4.9-5-.1.8 4.9 3-1.1 1.8.2 1.5-.7 10.3.3 2.7.1 4 1.5 1.3-.1.4-.7 3 .5.8-.4.3-2-.4-2.4-2.1-1.8-1.1-3.7-.2-3.9z"
    />
    <path
      onClick={handleClick}
      id="SL"
      ...
      data-id="SL"
      d="m919.4 518.7-1.5.3v-2.3l-.9-1.7.2-1.8-1.2-2.7-1.5-2.3H910l-1.3 1.2-1.5.2-1 1.4-.7 1.7-3 2.8.7 4.7.9 2.3 2.9 3.5 4.1 2.5 1.5.5 1.3-2 .3-1.9 2.6-3.4 2.6-3z"
    />
    <path
      onClick={handleClick}
      id="SV"
      ...
      data-id="SV"
      d="m487.2 487 .6-2.5-.7-.7-1.1-.5-2.5.8-.1-.9-1.6-1-1.1-1.3-1.5-.5-1.4.4.2.7-1.1.7-2.1 1.6-.2 1 1.4 1.3 3.1.4 2.2 1.3 1.9.6 3.3.1.7-1.5z"
    />
    <path
      onClick={handleClick}
      id="RS"
      data-name="Serbia"
      data-id="RS"
      d="m1084.8 285.2-3.2-1.5-.8-1.9-2.9-2.5-3.2-.2-3.7 1.6 1.5 2.4 1.7 1.8-1.7 2.3h1.8l-1 2.7 2.7 2.3-.5 2.9-1.2.3 1.5 1.1.8.8 1.8.7 2 1.2-.4.6 1.2-.5.5-2 .9-.4.8.9 1 .4.8 1 .8.3 1.1 1.1h.8l-.5 1.5-.5.7.2.5 1.7-.4 2.4-.1.7-.9-.6-.7.7-2 1.7-1.9-2.8-2.6-.7-2.3 1.1-1.4-1-1 1.1-1.1-1.4-.7-1.4 1.3-3.1-1.8-.7-2.5z"
    />
    <path
      onClick={handleClick}
      id="SR"
      data-name="Suriname"
      data-id="SR"
      d="m668 533.8-4.6.5-.6 1.1-6.7-1.2-1 5.7-3.5 1.6.3 1.5-1.1 3.3 2.4 4.6 1.8.1.7 3.5 3.3 5.6 3.1.5.5-1.3-.9-1.3.5-1.8 2.3.6 2.7-.7 3.2 1.4 1.4-2.7.6-2.9 1-2.8-2.1-3.7-.4-4.4 3.1-5.5-6-1.7z"
    />
    <path
      onClick={handleClick}
      id="SK"
      data-name="Slovakia"
      data-id="SK"
      d="m1087.4 260.9-4.9-2.3-3.4.8-2.4-.6-2.8 1.3-2.7-2.2-1.9.9-.3-.4h-1.5l-.6 1.1-1.1.3-.2 1.4-.9.3-.1.6-1.6.6-2.2-.1-.6 1.4-.3.8.7 2.1 2.6 1.6 1.9.7 4.1-.8.3-1.2 1.9-.2 2.3-1 .6.4 2.2-.7 1-1.5 1.6-.4 5.5 1.9 1-.6.7-2.5 1.1-1.7z"
    />
    <path
      onClick={handleClick}
      id="SI"
      data-name="Slovenia"
      data-id="SI"
      d="m1059.4 277-1.2-2.1-.8-.1-.9 1.1-4.3.1-2.4 1.4-4.2-.4-.3 3 1.4 2.7-1.1.5 3.5.2.8-1 1.8 1 2 .1-.2-1.7 1.7-.6.3-2.5 3.9-1.7z"
    />
    <path
      onClick={handleClick}
      id="SE"
      data-name="Sweden"
      data-id="SE"
      d="m1077.7 161.1-1.9-2.2-1.7-8.4-7.2-3.7-5.9-2.7-2.5.3v3.5l-7.9-.9-.6 3.1-4-.1-2.2 3.9-3.4 6.1-5.7 7.9 1.8 1.9-1.3 2.2-4.3-.1-2.3 5.3 1 7.6 3.1 2.9-.9 6.9-3.4 4-1.7 3.3 4.2 8.4 4.4 6.7 2 5.7 5.3-.3 2.2-4.7 5.7.5 2-5.5.6-10 4.6-1.3 3.3-6.6-4.8-3.3-3.6-4 2.1-8.1 7.7-4.9 6.1-4.5-1.2-3.5 3.4-3.9 7-1.5z"
    />
    <path
      onClick={handleClick}
      id="SZ"
      data-name="Swaziland"
      data-id="SZ"
      d="m1150.5 736.6-2.7-1.2-1.6.5-.7 1.8-1.6 2.4-.1 2.2 3 3.5 3.3-.7 1.3-2.8-.3-2.8-.6-2.9z"
    />
    <path
      onClick={handleClick}
      id="SY"
      data-name="Syria"
      data-id="SY"
      d="m1183.5 359.9 11-6.7.9-7.8-1.2-4.7 2.7-1.6 2.1-4.1-5.9 1.1-2.8-.2-5.7 2.5h-4.3l-3-1.2-5.5 1.8-1.9-1.3.1 3.6-1.2 1.5-1.2 1.4-1 2.6 1.1 5 2.4.3 1.2 2.5-2.6 2.4-.9 3.5.3 2.6-.6 1h.1l6.3 2.5 9.6-6.7z"
    />
    <path
      onClick={handleClick}
      id="TD"
    ...
    <path
      ...
      data-name="Togo"
      data-id="TG"
      d="m981.7 502.2-4.9-.1-.4 1.9 2.4 3.3-.1 4.6.6 5.1 1.4 2.3-1.2 5.7.4 3.2 1.5 4 1.2 2.2 4.6-1.3-1.4-4.4.2-14.6-1.1-1.3-.2-3.1-2-2.3-1.7-1.9.7-3.3z"
    />
    <path
      onClick={handleClick}
      id="TH"
    ...
    <path
      ...
      data-id="TJ"
      d="m1344.1 315.7-2.1.2-1.3-1.8.2-2.9-6.4 1.5-.5 4-1.5 3.5-4.4-.3-.6 2.8 4.2 1.6 2.4 4.7-1.3 6.6 1.8.8 3.3-2.1 2.1 1.3.9-3 3.2.1.6-.9-.2-2.6 1.7-2.3 3.2 1.5v2l1.6.3 1 5.4 2.6 2.1 1.5-1.3 2.1-.7 2.5-2.9 3.8.5h5.4l-1.8-3.7-.6-2.5-3.5-1.4-1.6.6-3-5.9-9.5.9-7.1-2-5.4.5-.6-3.7 5.9 1.1 1.4-2z"
    />
    <path
      onClick={handleClick}
      id="TM"
    ...
    <path
      ...
      data-id="TL"
      d="m1676.8 631.9 4.9-1.8 6-2.8 2.2-1.7-2-.8-1.8.8-4 .2-4.9 1.4-.8 1.5.5 1.3-.1 1.9z"
    />
    <path
      onClick={handleClick}
      id="TN"
      data-name="Tunisia"
      data-id="TN"
      d="m1038 361.4-2-1-1.5-3-2.8-.1-1.1-3.5 3.4-3.2.5-5.6-1.9-1.6-.1-3 2.5-3.2-.4-1.3-4.4 2.4.1-3.3-3.7-.7-5.6 2.6-1 3.3 1 6.2-1.1 5.3-3.2 3.6.6 4.8 4.5 3.8v1.5l3.4 2.6 2.6 11.3 2.6-1.4.4-2.7-.7-2.6 3.7-2.5 1.5-2 2.6-1.8.1-4.9z"
    />
    <path
      onClick={handleClick}
      id="TR"
      data-name="Turkey"
      data-id="TR"
      d="m1166.6 308.9-9.7-4.4-8.5.2-5.7 1.7-5.6 4-9.9-.8-1.6 4.8-7.9.2-5.1 6.1 3.6 3-2 5 4.2 3.6 3.7 6.4 5.8-.1 5.4 3.5 3.6-.8.9-2.7 5.7.2 4.6 3.5 8-.7 3.1-3.7 4.6 1.5 3.2-.6-1.7 2.4 2.3 3 1.2-1.4 1.2-1.5-.1-3.6 1.9 1.3 5.5-1.8 3 1.2h4.3l5.7-2.5 2.8.2 5.9-1.1 2.1-1 6.2.9 2.1 1.6 2.3-1.1-3.7-5.2.7-2-2.9-7.3 3.3-1.8-2.4-1.9-4.2-1.5v-3.1l-1.3-2.2-5.6-3-5.4.3-5.5 3.2-4.5-.6-5.8 1-7.8-2.4zm-49.6 4 2-1.9 6.1-.4.7-1.5-4.7-2-.9-2.4-4.5-.8-5 2 2.7 1.6-1.2 3.9-1.1.7.1 1.3 1.9 2.9 3.9-3.4z"
    />
    <path
      onClick={handleClick}
      id="TW"
      data-name="Taiwan"
      data-id="TW"
      d="m1642.3 427.2 1.2-10.2.1-3.9-2.9-1.9-3.3 4.8-1.9 6.3 1.5 4.7 4 5.4 1.3-5.2z"
    />
    <path
      onClick={handleClick}
      id="TZ"
    ...
    <path
      ...
      data-name="Uganda"
      data-id="UG"
      d="m1167.6 545.1-3.4 3-4-.1-4.5 1.5-3.5-1.4-2.3 1.7-.3 7.5 2.3.8-1.8 2.3-2.2 1.7-2.1 3.3-1.2 3-.3 5.1-1.3 2.4-.1 4.8 1.4.6 3.3-1.9 2-.8 6.2.1-.3-2.5 2.6-3.7 3.5-.9 2.4-1.5 2.9 1.2.3.5v-.3l1.6-2.6 2.7-4.2 2.1-4.7-2.6-7.3-.7-3.2-2.7-4.4z"
    />
    <path
      onClick={handleClick}
      id="UA"
    ...
    <path
      ...
      data-name="Uruguay"
      data-id="UY"
      d="m692.5 787-2.1-3.7 1.9-3-3.8-4.3-4.8-3.5-6.2-4.1-1.9.2-6.2-4.9-3.4.7-.5 5.1-.3 6.5 1.1 6.3-.9 1.4.4 4.2 3.9 3.5 3.6-.2 5.4 2.7 2.7-.6 4.2 1.2 5.3-3.5 1.6-4z"
    />
    <path
      onClick={handleClick}
      id="US"
    ...
    <path
      ...
      data-name="Vanuatu"
      data-id="VU"
      d="m1908.6 676.9-2.7-3.6-.6 1.7 1.3 2.8 2-.9zm-2-9.7-2.3-2-.9 4.9.5 1.8 1.2-.4 1.3.8.2-5.1z"
    />
    <path
      onClick={handleClick}
      id="YE"
      data-name="Yemen"
      data-id="YE"
      d="m1271.5 466.2-2.1-4.4-5.2-10.5-15.7 2.4-5 2.9-3.5 6.7-2.5 1-1.6-2.1-2.1.3-5.4-.6-1-.7-6.4.2-1.5.6-2.4-1.7-1.2 3.1.7 2.7-2.3 2.1.4 2.7-.6 1.3.7 2.9-1.1.3 1.7 2.6 1.3 4.7 1 1.9v3.4l1.6 3.8 3.9.3 1.8-.9 2.7.2.8-1.7 1.5-.4 1.1-1.7 1.4-.4 4.7-.3 3.5-1.2 3.1-2.7 1.7.4 2.4-.3 4.7-4.5 8.8-3 5.3-2.7v-2.1l.9-2.9 3.9-1.7z"
    />
    <path
      onClick={handleClick}
      id="ZA"
    ...
    <path
      ...
      data-name="Zimbabwe"
      data-id="ZW"
      d="m1148.2 713.7 6.2-7.2 1.6-4.6.9-.6.8-3.7-.8-1.9.5-4.7 1.3-4.4.3-8.1-2.8-2-2.6-.5-1.1-1.6-2.6-1.3-4.6.1-.3-2.4-4.2.9-3.3 2.5-.7 2.2-2 .5-5.1 5.3-3.2 4.1-1.9.1-1.7-.7-6.2-.7 1.9 5.1 1.1 1.1 1.6 3.7 6 7 2.3.7-.1 2.2 1.5 4.1 4.2.9 3.4 2.9 2.2.1 2.6 1.1 1.9-.8 2.9.6z"
    />
    <path
      onClick={handleClick}
      id="SO"
      data-name="Somalia"
      data-id="SO"
      d="m1223.4 505.7-2.6-2.7-1.2-2.6-1.8-1.2-2 3.4-1.1 2.3 2.2 3.5 2.1 3.1 2.2 2.2 18.5 7.6 4.8-.1-15.4 19.1-7.4.3-4.9 4.5-3.6.1-1.5 2-4.8 7.2.2 23.2 3.3 5.3 1.3-1.5 1.3-3.4 6.1-7.7 5.3-4.8 8.3-6.4 5.6-5.1 6.4-8.7 4.7-7.1 4.6-9.3 3.2-8.2 2.5-7.1 1.3-6.8 1.1-2.3-.2-3.4.4-3.7-.2-1.7h-2.1l-2.6 2.2-2.9.6-2.5.9-1.8.2-3.2.2-1.9 1.1-2.8.5-4.8 1.9-6.1.8-5.2 1.6h-2.8z"
    />
    <path
      onClick={handleClick}
      id="GF"
      ...
      data-id="GF"
      d="m681.4 556.2 1.8-4.7 3.5-5.8-.9-2.6-5.8-5.4-4.1-1.5-1.9-.7-3.1 5.5.4 4.4 2.1 3.7-1 2.7-.6 2.9-1.4 2.8 2.4 1.3 1.8-1.8 1.2.3.8 1.8 2.7-.5 2.1-2.4z"
    />
    <path
      onClick={handleClick}
      id="FR"
    ...
    <path
      ...
      data-name="Spain"
      data-id="ES"
      d="M985 325.7v-.2h-.5l-.3-.4-.1.2-.1.2v.2h.5l.4.1.1-.1zm-.8-1.6h.3l.6-.7v-.3l-.3-.2-1.1.2-.2.3v.3l-.3.1-.1.4.1.2.8.1.2-.4zM967 296l-8.2-.2-4.2.3-5.4-1h-6.8l-6.2-1.1-7.4 4.5 2 2.6-.4 4.4 1.9-1.6 2.1-.9 1.2 3.1h3l.9-.8 3 .2 1.3 3.1-2.4 1.7-.2 4.9-.9.9-.3 3-2.2.5 2 3.8-1.6 4.3 1.8 1.9-.8 1.7-2 2.5.4 2.1 4.8 1 1.4 3.7 2 2.2 2.5.6 2.1-2.5 3.3-2.3 5 .1h6.7l3.8-5 3.9-1.3 1.2-4.2 3-2.9-2-3.7 2-5.1 3.1-3.5.5-2.1 6.6-1.3 4.8-4.2-.3-3.5-6 .8-5.7-2.8-1.9 1.3-9.4-2.8-2-2.4zm26 22.6.1-.3.1-.2.1-.1-.2-.2v-.1l.2-.2-.2-.1-1.3.4-.7.4-2.1 1.5v.3l.1.2h.4l.2.4.4-.4.3-.1.3.1.3.2.1.6.1.2.6.1.9.4.4-.2.5-.3.2-.6.3-.5.3-.5.3-.4-.1-.4-.3-.1-.3-.1-.5.2-.5-.2zm6-.3.1-.4v-.1l-.5-.7-.9-.3-1 .1-.1.1v.4l.1.1.6.1 1.6.7h.1z"
    />
    <path
      onClick={handleClick}
      id="AW"
      data-name="Aruba"
      data-id="AW"
      d="m586.6 492.9-.1-.1-.3-.6-.3-.3-.1.1-.1.3.3.3.3.4.3.1v-.2z"
    />
    <path
      onClick={handleClick}
      id="AI"
      data-name="Anguilla"
      data-id="AI"
      d="m627.9 456.2.1-.2-.2-.1-.8.5v.1l.9-.3z"
    />
    <path
      onClick={handleClick}
      id="AD"
      data-name="Andorra"
      data-id="AD"
      d="m985.4 301.7.1-.2.1-.2v-.1l-.2-.1-.7-.2-.3-.1-.2.1-.2.2-.1.3.1.1v.4l.1.2h.4l.3-.1.5-.3h.1z"
    />
    <path
      onClick={handleClick}
      id="AG"
      ...
      data-id="AG"
      d="m634.3 463.8.2-.1V463.4l-.1-.1-.1-.2-.4-.2-.5.5v.2l.1.3.6.1.2-.2zm.2-3.5v-.5l-.1-.2h-.3l-.1-.1h-.1l-.1.1.1.6.5.3.1-.2z"
    />
    <path
      onClick={handleClick}
      id="BS"
      data-name="Bahamas"
      data-id="BS"
      d="m574.4 437.3.2-.6-.3-.1-.5.7-.6.3h-.3l-.7-.3h-.5l-.4.5-.6.1.1.1v.2l-.2.3v.2l.1.3 1.5-.1 1.3-.2.7-.9.2-.5zm.8-2-.4-.3-.4.3.1.3.7-.3zm0-5.8-.4-.2-.3.5.3.1.7-.1.5.1.5.4.3-.2-.1-.1-.4-.3-.6-.1h-.2l-.3-.1zm-6.6 1.3.7-.6.7-.3.9-1.1-.1-.9.2-.4-.6.1-.1.3-.1.3.3.4v.2l-.2.4-.3.1-.1.2-.3.1-.4.5-.8.6-.2.3.4-.2zm1.2-3.2-.6-.2-.2-.4-.4-.1-.1.2v.2l.1.4.2-.1.8.4.4-.3-.2-.1zm-4.1-1.1v-.7l-.4-.5-.6-.4-.1-1.2-.3-.7-.2-.6-.4-.8v.5l.1.1.1.6.4.9.1.4-.1.4-.4.1-.1.2.5.3.8.3.5 1.3.1-.2zm-4.1-3.5-.5-.3-.2-.3-.7-.7-.3-.1-.2.4.4.1.9.7.4.2h.2zm7.3-4-.1-.3h-.1l-.3.1-.3.9h.3l.5-.7zm-17.6-1.1-.2-.3-.3.2h-.5l-.2.1h-.4l-.3.2.4.8.3.3.1 1 .2.1-.1.7 1.1.1.4-.8V418.6l-.3-.5-.4.6-.4-.3.6-.4v-.1zm12.9.3-1-1.4v-.2l-.5-1.5-.3-.1-.1.1-.1.2.4.4v.4l.3.2.4 1.1.4.4-.1.3-.4.3-.1.2h.1l.6-.1h.4v-.3zm-10.5-5.2.5-.2-.3-.2h-.7l-.4.1-.2.2.1.1.4.1.6-.1zm-2.4 2-.5-.6-.3-.9-.2-.4.1-.5-.3-.4-.6-.4-.3.1.1 1.1-.2.6-.8 1.1.1.4.1.2-.5.4v-.3l-.6.1.3.5.6.4.3.1.3-.2v.5l.3.4.1.4.3-.3.6-.2.2-.2.7-.4v-.2l.1-.6.1-.7zm6.7-5-.3-.5-.1.1-.1.4-.3.4.5-.1.4.1.6.5.7.2.3.6.6.6v.6l-.4.6-.1.7-.6.1.1.1.3.3.1.4.2.2v-.7l.3-.8.4-1.3-.1-.3-.3-.3-.7-.9-.7-.3-.8-.7zm-8.8-7.9-.5-.4-.2.4v.1l-.1.3-.5.4-.5.1-.7-.6-.2-.1.8 1.1.3.1h.4l.9-.3 1.6-.5 1.7-.2.1-.2-.1-.3-.8.2-1-.1-.2.2h-.4l-.6-.2zm6.1 5.2.2-.3.4-1.8.8-.6.1-1.2-.5-.5-.4-.2-.1-.2.1-.2-.2-.1-.3-.2-.4-.6-.4-.4-.7-.1-.6-.1-.4-.1-.5.3h.8l1.5.3.7 1.5.5.4.1.4-.2.4v.4l-.3.5-.1.8-.3.4-.7.5.4.2.3.6.2-.1z"
    />
    <path
      onClick={handleClick}
      id="BM"
      data-name="Bermuda"
      data-id="BM"
      d="m630.2 366.8.4-.6h-.1l-.5.5-.6.2.1.1h.1l.6-.2z"
    />
    <path
      onClick={handleClick}
      id="BB"
      data-name="Barbados"
      data-id="BB"
      d="m644.9 488.9.4-.4-.3-.3-.6-.8-.3.1v1l.1.3.5.3.2-.2z"
    />
    <path
      onClick={handleClick}
      id="KM"
      data-name="Comoros"
      data-id="KM"
      d="m1221.1 650.5-.4-.4h-.4v.2l.1.4 1.1.2-.4-.4zm3.9-1.5h-.1l-.2.1-.1.2-.1.3h-.9l.8.5.5.5.2.2.1-.2.1-.7-.3-.9zm-5.6-1.1.2-.3-.2-.7-.4-.8.1-1.4-.2-.2h-.3l-.1.1-.1.3-.3 2 .4.6.3.1.5.4.1-.1z"
    />
    <path
      onClick={handleClick}
      id="CV"
    ...
    <path
      ...
      data-name="Cayman Is."
      data-id="KY"
      d="m527 449.1-.1-.3-.1.1v.6h.7l.3-.2h.6l-.1-.2-.8-.1-.1.1-.2.1-.2-.1zm8-2.3-.1-.1h-.1l-.3.1h-.2l-.1.1-.1.1h.2l.4-.2H535zm.8-.1.5-.2-.1-.1h-.1l-.1.1h-.1l-.5.3h.2l.2-.1z"
    />
    <path
      onClick={handleClick}
      id="DM"
      data-name="Dominica"
      data-id="DM"
      d="m635.8 475.1.3-.7-.1-1-.2-.4-.8-.3v.2l-.1.5.3.8.1 1.1.5-.2z"
    />
    <path
      onClick={handleClick}
      id="FK"
      ...
      data-id="FK"
      d="m690.3 902.7-.1-.3-.4-.2-.2-.1.1.2.1.3.1.2.2.1.2-.2zm5.5-1.3-.1-.1h-.2l-.1.2.2.3.4.1-.2-.5zm-12.9-1.4-.1.2-.4.1.2.3.6.4h.4l.1-.3-.1-.6h-.3l-.4-.1zm2.8-2-.9-.3-.4-.3h-.3l.4.4.1.2.1.2.6.3.6.3.4.3-.1.1-.8.3h-.3l-.2.1.4.2.6-.1.2-.1h.2l.3.1v.2l-.1.2-.2.2-.4.3-.6.4h-.8l-.7.7.9.5.7.3h.9v-.1l.2-.1h.3l.1-.1.2-.4v-.6h.2l.3.1.7-.1.3-.1.6-.9.4-.8.2-.4.3-.2.1-.2.1-.3.3-.2v-.3l-.4-.2-.3-.2-.3.3-.2-.1-.9.3h-.4l-.3-.2-.4-.1-.4.1-.5.5-.8-.2zm.7-.4.1-.3-.1-.2-.5-.2h-.5l.2.5.2.2h.6zm5.9-.7h-.4l.4.5-.8.8.2.6.3.4.1.2-.1.1-.4.1-.3.1-.2.3-.9.9.2.2-.3.7.2.3.8.7.8.4v-.7l.4-.1.4.2.4-.2-.9-1h.3l2.5.5-.1-.4-.1-.2-.3-.4 1.5-.4.5-.3.2-.3.6-.1.8-.3-.1-.1.1-.3-.4-.2-.5-.1.1-.3.5-.1-.8-.7-.3-.1-1 .1-.3.1v.2l.1.3.3.3.1.2-.2-.1-1.1-.4-.2-.1-.2-.4.2-.1.3.1.1-.3-.4-.3-.4-.1-.9.1-.8-.3z"
    />
    <path
      onClick={handleClick}
      id="FO"
      data-name="Faeroe Is."
      data-id="FO"
      d="M947 186.9v-.3l-.1-.3v-.2h-.1l-.5-.1-.1-.2h-.1v.2l.1.4.5.4.3.2h.1l-.1-.1zm.5-2.1v-.1l-.2-.2-.5-.2-.2-.1-.2.1v.2l.1.1.4.1.4.3h.1l.1-.2zm-2.4-1.9-.2-.1-.5.1h-.3l.1.3.6.2h.6l.2-.1-.1-.2-.4-.2zm2.5-.5-.8-.2-.6-.3-1 .1.7 1.1.8.7.4.2V183.7l-.4-.5-.1-.1v-.1l.1-.1h.2l.3.2h.2l.2-.7zm1-.2-.3-.2-.4-.4v.9h.1l.3.1.3-.4z"
    />
    <path
      onClick={handleClick}
      id="GD"
      data-name="Grenada"
      data-id="GD"
      d="m632.1 495.7.5-.2.2-1.1-.3-.1-.3.3-.3.5v.4l-.2.3.4-.1z"
    />
    <path
      onClick={handleClick}
      id="HK"
      data-name="Hong Kong"
      data-id="HK"
      d="M1604.9 430.9v-.4l-.4-.2h-.3l.1.2.4.5.2-.1zm-1.3 0-.1-.5.2-.3-.9.3-.1.3v.1l.2.1h.7zm1.6-1.2-.1-.3-.2-.1-.1-.3-.1-.2-.3-.1-.2-.1h-.4l-.1.1h-.2l-.2.2v.2l-.5.4v.2l.3.2.5-.1.6.2.8.3v-.5l.2-.1z"
    />
    <path
      onClick={handleClick}
      id="KN"
      ...
      data-id="KN"
      d="M629.9 463.2v-.3l-.2-.2h-.3v.5l.2.2.3-.2zm-.5-.7-.1-.2-.1-.1-.2-.4-.4-.4-.2.1-.1.2v.1l.3.3.4.1.2.4.2-.1z"
    />
    <path
      onClick={handleClick}
      id="LC"
      ...
      data-id="LC"
      d="m637.4 484.2.1-1.2-.1-.5-.2.1-.3.4-.4.6-.1.3v.6l.6.4.4-.7z"
    />
    <path
      onClick={handleClick}
      id="LI"
    ...
    <path
      ...
      data-name="Maldives"
      data-id="MV"
      d="m1389.1 551.6.1-.1v-.2l-.1-.1h-.1l-.1.2v.2h.2zm.3-5.9.1-.2v-.4l-.1.1-.1.2v.1l-.1.1v.1h.2z"
    />
    <path
      onClick={handleClick}
      id="MT"
      data-name="Malta"
      data-id="MT"
      d="m1053.6 344-.2-.2-.5-.5-.5-.1.1.6.4.4h.5l.2-.2zm-1.4-1.2v-.2l-.3-.1-.4.1.1.1.3.2.3-.1z"
    />
    <path
      onClick={handleClick}
      id="MS"
      ...
      data-id="MS"
      d="m631.8 465.7-.1-.5h-.1l-.2.4v.3l.3.1.1-.3z"
    />
    <path
      onClick={handleClick}
      id="MU"
      data-name="Mauritius"
      data-id="MU"
      d="m1294.7 702.5.3-.3.2-.4.3-.3.1-.7-.2-.8-.4-.7-.5.1-.3.4-.2.5-.5.3-.1.3-.2.7-.1.4-.2.1v.2l.3.3.8.1.7-.2z"
    />
    <path
      onClick={handleClick}
      id="NC"
    ...
    <path
      ...
      data-name="Nauru"
      data-id="NR"
      d="M1915 575.5v-.2h-.2l-.1.2.1.1.1.1.1-.2z"
    />
    <path
      onClick={handleClick}
      id="PN"
    ...
    <path
      ...
      data-id="PR"
      d="M600.8 457.3v-.1h.1v-.1l.1-.1v-.1h-.5v.2l.2.1v.1h.1zm13.6-.3.7-.2v-.1l-.4-.1h-.6l-.5.2.1.2h.7zm-3.7-2.2-.1-.2h-.2l-3.5-.1-1.3-.2-.3.1-.3.1-.1.4-.2.2-.3.2.1.3.1.2.2.4-.1.5-.2 1 .3.2.7-.1.3.1.3.1.4-.1.4-.2.9.1.5-.1.6.3.4-.1.2.1H610.4l.9-.2.8-.5.3-.5.4-.3.6-.4v-.9l-.7-.1-.6-.3-1.1-.1h-.1l.1.2h-.1l-.2-.1z"
    />
    <path
      onClick={handleClick}
      id="PF"
      ...
      data-id="PF"
      d="m213.2 704.9-.1-.3-.2-.3-.1.1.1.1.2.3v.2l.1-.1zm9.3-14.7-.2-.2-.4-.2-.2-.1-.2-.1-.1.1.1.1h.1l.3.2.3.1.2.1v.1l.1-.1zm-24.5-1.1-.6-.3.1.2.4.2.2.1-.1-.2zm20.5-.2-.4-.5h-.3l.7.6v-.1zm-21.6-1-.4-.4-.2-.3-.3-.1.1.1.4.4.3.4.2.1-.1-.2zm-.3-2.1-.1-.1v-.3l.2-.3.6-.4v-.1l-.2.1-.4.2-.2.2-.1.2-.1.3.1.2.1.1h.2l-.1-.1zm-47.4-1.1-.2-.6-.3-.5-.8-.1-.5.2-.1.2.1.4.5.7.5.1.8-.1.4.6.2.1.4.1.1-.3-.2-.5-.9-.3zm-2.9-.9.1-.4-.2-.1h-.5v.2l.1.2.1.1.3.2.1-.2zm-9.7-4.3h.2l-.4-.6-.3-.2V679.5l.3.1.2-.1zm43.9-1.6h-.6l.5.1.4.2-.3-.3zm-.7.1-.3-.1-.3-.2h-.3l.7.3h.2zm-43.8.1.1-.2-.1-.1-.4-.2.1.3v.2l.2.1.1-.1zm32.8-2-.3-.4-.2-.3-.2-.4-.4-.5.1.3.1.2.2.2.2.4.1.2.3.4h.1v-.1zm16.2-1.5.1-.5h-.2v.5h.1zm-14.4-1.6-.6-.6h-.1l.1.2.5.5.1.2v-.3zm30.8-33.9.1-.2v-.2l-.1-.1-.3-.1.1.7.2-.1zm-2.7-3.7-.1-.2h-.2l-.1.1v.5l.4-.4zm.1-1.6-.8.5.2.4.4.1.2-.2.8-.1.3-.4-.3.1-.8-.4zm-6.1-1.7.2-.5-.2-.1-.4.2v.2l.3.4.1-.2zm2.6-3.1.3-.1v-.1l-.2-.2-.3-.1-.1.1-.1.2.1.3.3-.1zm-2.9-.1.1-.3v-.2l-.1-.2-.9-.2-.1.1v.4l.2.5h.3l.5-.1z"
    />
    <path
      onClick={handleClick}
      id="SG"
      data-name="Singapore"
      data-id="SG"
      d="m1561 563.7.1-.2-.2-.2-.3-.1-.5-.2-.6.1-.3.6.9.4.9-.4z"
    />
    <path
      onClick={handleClick}
      id="SB"
    ...
    <path
      ...
      data-id="SX"
      d="m627.1 457.2.2.2.3.1.1-.1v-.2h-.6z"
    />
    <path
      onClick={handleClick}
      id="SC"
      ...
      data-id="SC"
      d="m1288.5 602-.5-.8-.4.3.2.3.3.2.1.4.3.2v-.6z"
    />
    <path
      onClick={handleClick}
      id="TC"
      ...
      data-id="TC"
      d="m578.7 433.1-.1.4v.2l.2.1.6-.1.1-.1.2-.1v-.1l-.4.1-.6-.4zm3.6.6.2-.2-.2-.2-.7-.2-.2.1v.3h.6l.3.3v-.1zm-1.1-.5-.1-.1-.1-.6h-.5v.2l.1.2h.1l.1.2.3.2.1-.1z"
    />
    <path
      onClick={handleClick}
      id="TO"
      data-name="Tonga"
      data-id="TO"
      d="m13.3 707.7-.2.3v.2l.4.4-.2-.9zm-1.6-.9h-.2l.2-.1-.4-.2h-.4l-.2-.1v-.2l-.2.3.2.3.9.4.3.2.2-.6v-.2l-.3.1v.1h-.1zm2.5-16 .1-.2v-.2l-.3-.1h-.1l-.3.5.1.1.3.2h.1l.1-.3z"
    />
    <path
      onClick={handleClick}
      id="TT"
      ...
      data-id="TT"
      d="m635.4 507.7.1-.2v-.6l.2-.4-.2-.4-.1-.6.1-.5v-.7l.2-.3.5-.8h-.9l-.6.2-1.1.1-.5.2-.7.1-.4.2.1.1.5.2.2.2.1.2.1.4-.3 1.7-.1.1-.6.1-.2.3-1.4.8.8-.1.9.1 2.4-.1.9-.3zm1.8-6.7 1.2-.5.1-.4h-.2l-.8.3-.6.5v.2l.3-.1z"
    />
    <path
      onClick={handleClick}
      id="VC"
      ...
      data-id="VC"
      d="M634.5 491.4v-.1h.1v-.2h-.1v.2h-.1v.1h.1zm.7-1.9.1-.2.1-.1-.1-.1v.1l-.2.1v.2h-.2.1l.1.1.1-.1zm.3-1.1.3-.2.1-.6-.1-.4h-.2l-.3.1-.2.3-.1.5.4.4.1-.1z"
    />
    <path
      onClick={handleClick}
      id="VG"
      ...
      data-id="VG"
      d="m619.2 455.1.3-.2-.2-.1h-.4l-.3.2.1.1h.5zm1.1-.4.4-.4-.5.1-.2.2.1.1h.2zm.8-1.8h-.7l.1.1h.3l.3.1v-.2z"
    />
    <path
      onClick={handleClick}
      id="VI"
      ...
      data-id="VI"
      d="m617.9 458.9-.7.2-.1.4h1.1l.7-.3h-.6l-.4-.3zm.9-3.5-.5-.1-.2.2.3.1.4-.2zm-1.1.1-.2-.2-.3-.1-.4.1.5.3.4-.1z"
    />
    <path
      onClick={handleClick}
      id="CY"
      data-name="Cyprus"
      data-id="CY"
      d="m1149.9 348.4-.3-.1-.5.2-.4.4-.4.3-.5-.3.2.9.6 1.1.2.3.3.2 1.1.3H1151.1l.2.1.2.4h.4v-.4l.2-.2.3-.2h.3l.6-.1.6-.2.5-.4.9-1h1.2l.6-.1-.2-.4-.1-.1-.4-.5-.2-.4.1-.6 2.5-1.9.5-.5-.8.2-.6.4-.4.2-.7.4-2.3.8-.8.1h-.8l-1-.1-.9-.2v.7l-.2.6-.6.2-.3-.1z"
    />
    <path
      onClick={handleClick}
      id="RE"
      data-name="Reunion"
      data-id="RE"
      d="m1284 707.9.2-.4.1-.8-.4-.8-.4-.7-.4-.2-.8-.1-.7.3-.4.6-.2.3.4 1.1.2.3 1.1.6h.5l.8-.2z"
    />
    <path
      onClick={handleClick}
      id="YT"
    ...
    <path
      ...
      data-id="MQ"
      d="m638 479.9-.2-.7-.1-.2-.2-.3.1-.3v-.1h-.2l-.3-.5-.6-.3h-.3l-.2.2v.3l.3.9.2.2.5.2-.4.4v.1l.1.3h.9l.2.3.1-.1.1-.4z"
    />
    <path
      onClick={handleClick}
      id="GP"
      ...
      data-id="GP"
      d="m636.4 471.1.2-.2v-.3l-.2-.3-.2.1-.2.3v.3l.1.1h.3zm-1.9-.8.2-.2v-1.2l.1-.3-.2-.1-.2-.2-.6-.2-.1.1-.2.3.1 1.5.2.5.2.1.5-.3zm1.6-1.4.8-.2-.9-.6-.2-.4v-.3l-.4-.3-.2.2-.1.3.1.5-.3.4.1.4.4.1.7-.1z"
    />
    <path
      onClick={handleClick}
      id="CW"
